...
module.exports = async function handler(req, res) {
  ...
  const [
    ...
    // Count businesses disqualified today. We use updated_at as a proxy because there's no
    // dedicated disqualified_at column; combined with the not-null filter this slightly
    // over-counts when an already-disqualified business is later edited, but it's the
    // closest signal available and that case is rare in practice.
